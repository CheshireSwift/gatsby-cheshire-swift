...
import * as cell from './philippa/cellState';
import { Board } from './philippa/board';
import { Grid } from './philippa/grid';
...
describe('Grid', () => {
  it('has as many buttons as squares', () => {
    const grid = render(
      <Grid squares={initialState} sideLength={3} onClickHandler={() => null} />
    );
